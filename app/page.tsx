      ...
      <div className="bg-white py-24 sm:py-32 rounded-md drop-shadow-xl">
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-600 sm:text-5xl">
              Transform your PDF into Interactive Conversations
            </p>
            <p className='mt-6 text-lg leading-8 text-gray-600'>
              Introducing{" "}
              <span className="font-bold text-indigo-600">Yap PDF</span>
              <br />
              <br />
              Upload your document, and our chatbot will summarize content, and answer all your Qs. Ideal for everyone, <span className="text-slate-800">Yap PDF</span>{" "}
              <span className="font-bold">dynamic conversations</span>, enhancing productivity <span className='text-indigo-600 font-semibold'>10x</span> fold effortlessly.
            </p>
          </div>
